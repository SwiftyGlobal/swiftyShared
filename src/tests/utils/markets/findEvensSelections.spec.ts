...
describe('findEvensSelections', () => {
  ...
  it('ignores a two-item line when both selections have the same outcome_id, but still picks a valid other line', () => {
    const payload: TestSelection[] = [
      // Invalid pair: same outcome_id
      {
        bet_id: 'u-1',
        trading_status: 'open',
        outcome_type: 'draw',
